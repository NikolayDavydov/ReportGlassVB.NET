...
Public Class Report
    ...
    Public portions As New List(Of PORTION)()
    ...
    '    Dim portions = From fold In System.IO.Directory.EnumerateDirectories(path_tmp, "?", System.IO.SearchOption.TopDirectoryOnly)
    '    For Each folder In portions
    '        Dim number As Integer
    '        Dim result As Boolean = Int32.TryParse(My.Computer.FileSystem.GetName(folder), number)
    '        If result Then
    '            ' portions.(New PORTION(folder))
    '        End If
